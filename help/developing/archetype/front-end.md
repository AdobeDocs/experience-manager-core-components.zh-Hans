...
可使用[AEM clientlib.](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/full-stack/clientlibs.html)获取前端模块。在执行NPM生成脚本时，将生成应用程序，`aem-clientlib-generator`包将获取生成的生成输出并将其转换为此类clientlib。
