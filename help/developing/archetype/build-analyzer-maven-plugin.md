...
| `aem-provider-type` | 检查应用程序代码是从AEM（产品）实现还是扩展“ProviderType”接口/类，请参见[CQBP-84](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/using/how-to-use/custom-code-quality-rules.html?lang=en#product-apis-annotated-with-providertype-should-not-be-implemented-or-extended-by-customers) | 是 | 是 |
| `configurations-basic` | 检查OSGi配置是否存在常见错误，例如没有为“service.ranking”属性指定正确的类型。 | 是 | 是 |
