...
模板作者可以在设计对话框中定义允许的图像宽度以及裁剪和其他 [设置](#design-dialog)。 内容编辑器可以在“配置”对话框中上传或 [选择资产](#configure-dialog) ，并在“编辑”对话框中裁 [剪图像](#edit-dialog)。 为了更方便起见，还可以对图像进行简单的就地修改。
...
>本文档描述了图像组件的v1。
>
>有关图像组件的当前版本的详细信息，请参阅图 [像组件文档](/help/components/image.md) 。
