...
模板作者可以在[设计对话框](#design-dialog)中定义可用列表类型和格式选项。 内容编辑器可以从[编辑对话框](#edit-dialog)中的可用列表类型以及如何格式化列表元素。

## 版本和兼容性{#version-and-compatibility}

本文档描述了最初随带AEM 6.3的核心组件版本1.0.0引入的列表组件的v1。
...
无论如何构建列表，都有[排序选项](#sort-options)始终可以配置。
...
* **显示说明** -在编辑对话框中启用“显示说 [明”选项](#edit-dialog)
* **显示日期** -在编辑对话框中启用“显示 [日期”选项](#edit-dialog)
