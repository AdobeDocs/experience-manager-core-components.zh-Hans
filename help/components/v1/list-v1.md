...
可用列表类型和格式选项可由模板作者在设计对话框中定 [义](#design-dialog)。 内容编辑器可以从可用的列表类型中进行选择，以及如何在编辑对话框中设置列 [表元素格式](#edit-dialog)。
...
>本文档描述了列表组件的v1。
>
>有关列表组件当前版本的详细信息，请参阅列 [表组件文档](/help/components/list.md) 。
...
* **显示描述** -在编辑对话框中启用显示 [描述选项](#edit-dialog)
