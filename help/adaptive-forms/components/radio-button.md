...
选项卡用于定义和管理组件的CSS样式。 自适应表单单选按钮核心组件支持 AEM [样式系统](/help/get-started/authoring.md#component-styling)。

![样式设计对话框](/help/adaptive-forms/assets/radiobutton_designdialog.png)
