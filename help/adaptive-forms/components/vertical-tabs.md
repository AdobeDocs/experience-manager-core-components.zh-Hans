...
| --- | --- |
| v1 | 兼容<br>[版本 2.0.18](/help/versions.md) 和更高版本 | 兼容 | 兼容 |
...
通过&#x200B;**允许使用的组件**&#x200B;选项卡，模板编辑者可设置可作为项添加到自适应表单编辑器中的垂直选项卡组件面板的组件。
