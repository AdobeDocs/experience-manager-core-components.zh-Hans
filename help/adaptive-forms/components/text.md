...
2023 年 2 月，作为核心组件 2.0.4 的一部分发布了自适应表单文本核心组件。下表展示所有支持的版本、AEM 兼容性和相应文档的链接：
...
“设计”对话框用于定义和管理组件的 CSS 样式。自适应表单文本核心组件支持 AEM [样式系统](/help/get-started/authoring.md#component-styling)。
