...
- **必需** - 如果要在自适应表单中显示该组件，请选中此选项。选择该选项后，在继续提交表单之前必须输入值。您无法选择 **隐藏组件** 或 **禁用组件**  在 **基本** 选项卡。
...
<br>
    ...
    - **模式** — 此选项允许您为电子邮件输入允许的验证模式。 也可以使用正则表达式。
    - **错误消息** — 利用此选项可输入在电子邮件ID无法通过在**Pattern**选项中输入的值进行验证时在屏幕上显示的消息
...
![自定义属性对话框](/help/adaptive-forms/assets/datepicker_customproperties.png)
