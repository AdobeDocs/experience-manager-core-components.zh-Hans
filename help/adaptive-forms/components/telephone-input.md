...
- **必需** - 如果要在自适应表单中显示该组件，请选中此选项。选择该选项后，您必须先输入值，然后才能继续提交表单。 选中此选项后，无法在&#x200B;**基本**&#x200B;选项卡中选择&#x200B;**隐藏组件**&#x200B;或&#x200B;**禁用组件**。
...
![自定义属性对话框](/help/adaptive-forms/assets/telephoneinput-customproperties.png)
...
“验证模式”选项卡允许您以特定格式输入值或满足特定条件。 默认情况下，某些选项可用，您可以通过选中相应的复选框来选择这些选项。 此外，您还可以通过单击 **添加** 按钮。
