...
# 电话号码输入 {#telephone-input-adaptive-forms-core-component}
...
“设计”对话框用于定义和管理电话号码输入组件的 CSS 样式。

### “样式”选项卡 {#styles-tab}

该选项卡用于定义和管理组件的 CSS 样式。自适应表单电话号码输入核心组件支持 AEM [样式系统](/help/get-started/authoring.md#component-styling)。

![“设计”对话框](/help/adaptive-forms/assets/telephoneinput_designdialog.png)

- **默认 CSS 类**：可为自适应表单电话号码输入核心组件提供默认 CSS 类。
