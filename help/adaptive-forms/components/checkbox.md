...
复选框通常表示为一个小方块，可通过单击或点击将其打开或关闭。 选中复选框后，将显示一个复选标记，以表明关联的选项或功能已激活或已启用。
...
自适应Forms复选框核心组件作为核心组件2.0.52的一部分发布。 下表显示所有支持的版本、AEM 兼容性以及相应文档的链接：

|  |  |
|---|---|
| 组件版本 | AEM as a Cloud Service |
| --- | --- |
| v1 | 与<br>[版本2.0.52](/help/adaptive-forms/version.md)及更高版本兼容\|兼容\|兼容 |
...
- **保留“取消选中”状态值** - 选中此选项可指定未选择复选框组件时返回的值。 如果&#x200B;**保留“取消选中”状态值**&#x200B;启用或设置为 true，则&#x200B;**取消选中时，返回值**&#x200B;选项会出现。
- **在取消选中时，返回值** - 利用此选项，您可以指定复选框在处于取消选中或未选中状态时应关联的值。

- **默认值**：通过此选项，可在表单字段中添加默认值。 如果选择了&#x200B;**禁用组件**，屏幕上会显示默认值。 如果用户未在表单字段中输入值，则在提交表单时提交此值。
