...
- **安全和隐私协议**：这&#x200B;**条款和条件**&#x200B;组件包括有关如何收集、存储和使用用户数据的详细信息，通常由单独的隐私政策进行补充
...
|---|---|---|
| v1 | 兼容<br>[版本 2.0.62](/help/adaptive-forms/version.md) 和更高版本 | 兼容<br>[版本 1.1.28](/help/adaptive-forms/version.md) 及更高但低于 2.0.0 的版本。 |
