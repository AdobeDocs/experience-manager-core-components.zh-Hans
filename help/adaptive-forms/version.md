...
# 自适应Forms核心组件版本 {#core-components-versions}

确定在您的环境中激活最新自适应Forms核心组件所需的Forms核心组件和WCM核心组件依赖项的精确版本。 此外，请熟悉在自适应Forms核心组件的每个版本中启用的组件和功能。

## AEM Forms作为Cloud Service版本历史记录 {#aem-as-cs-version-history}
...
| Forms核心组件 | WCM核心组件 | AEM Forms as a cloud service | Java | Maven |
|-----------------------|---------------------| ---------------------------- | ----- | ------ |
...
| Forms核心组件 | WCM核心组件 | AEM 6.5 | Java | Maven |
|-----------------------|---------------------|---------| ----- | ------ |
| 1.1.32 | 2.23.2 | 6.5.18+ | 8, 11 | 3.3.9 和更高版本 |
| 1.1.28 | 2.23.2 | 6.5.19+ | 8, 11 | 3.3.9 和更高版本 |
| 1.1.26 | 2.23.2 | 6.5.17+ | 8, 11 | 3.3.9 和更高版本 |
| 1.1.24 | 2.22.12 | 6.5.17+ | 8, 11 | 3.3.9 和更高版本 |
| 1.1.22 | 2.22.12 | 6.5.17+ | 8, 11 | 3.3.9 和更高版本 |
| 1.1.20 | 2.22.10 | 6.5.17+ | 8, 11 | 3.3.9 和更高版本 |
| 1.1.18 | 2.21.2 | 6.5.17+ | 8, 11 | 3.3.9 和更高版本 |
| 1.1.16 | 2.21.2 | 6.5.17+ | 8, 11 | 3.3.9 和更高版本 |
| 1.1.12 | 2.21.2 | 6.5.16+ | 8, 11 | 3.3.9 和更高版本 |
