...
核心组件的当前发行版本是 2.20.0，与 [AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html) 和[内部部署 AEM](https://experienceleague.adobe.com/docs/experience-manager-65/user-guide/home.html) 安装兼容。
...
|---|---|---|---|---|---|---|
| [2.20.2](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.20.2) | 这是一个修补程序版本，用于修复新AEMaaCS中的问题 [优化了web的资产交付服务。](/help/developing/web-optimized-image-delivery.md) | - | 6.5.10.0+ * | 连续 | 8, 11 | 2022年6月20日 |
| [2.20.0](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.20.0) | 此版本新增了 [目录组件](/help/components/tableofcontents.md)，添加了对AEMaaCS的支持 [优化了web的资产交付服务，](/help/developing/web-optimized-image-delivery.md) 以及错误修复。 | - | 6.5.10.0+ * | 连续 | 8, 11 | 2022年6月9日 |
| [2.19.0](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.19.0) | 这一发行版本引入了[搜索组件](/help/components/quick-search.md)的一个新版本、[按钮组件](/help/components/button.md)的一些新功能，以及多项辅助功能改进和错误修复。 | - | 6.5.10.0+ * | 连续 | 8, 11 | 2022年4月7日 |
